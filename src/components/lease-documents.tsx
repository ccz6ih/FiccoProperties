  ...
  return (
    <div className="border-t border-clay pt-4">
          ...
          {docs.map((d) => (
            <li key={d.id} className="flex items-center justify-between gap-3 py-2">
              <a
                ...
                className="flex items-center gap-2 text-sm font-medium text-pine hover:underline"
              >
                <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="1.8">
                  <path d="M6 2h8l4 4v16H6z" strokeLinejoin="round" />
                  <path d="M14 2v4h4" strokeLinejoin="round" />
                </svg>
                {d.label || "Signed lease"}
      ...
      <p className="mt-1 text-[11px] text-ink-faint">
        PDF or photo, up to 8&nbsp;MB. Staff-only — tenants can&apos;t see these.
      </p>
    </div>
  );
}
